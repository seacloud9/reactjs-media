(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/regenerator'), require('react'), require('prop-types'), require('react-icons/md'), require('@mui/material/Grid'), require('@mui/material/Slider'), require('@mui/material/IconButton'), require('@mui/material/Typography'), require('@mui/material/Tooltip'), require('@mui/material/Menu'), require('@mui/material/MenuItem')) :
  typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/slicedToArray', '@babel/runtime/regenerator', 'react', 'prop-types', 'react-icons/md', '@mui/material/Grid', '@mui/material/Slider', '@mui/material/IconButton', '@mui/material/Typography', '@mui/material/Tooltip', '@mui/material/Menu', '@mui/material/MenuItem'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactAudio = {}, global._asyncToGenerator, global._slicedToArray, global._regeneratorRuntime, global.React, global.PropTypes, global.md, global.Grid, global.Slider, global.IconButton, global.Typography, global.Tooltip, global.Menu, global.MenuItem));
})(this, (function (exports, _asyncToGenerator, _slicedToArray, _regeneratorRuntime, React, PropTypes, md, Grid, Slider, IconButton, Typography, Tooltip, Menu, MenuItem) { 'use strict';
...
//# sourceMappingURL=audio.umd.js.map
